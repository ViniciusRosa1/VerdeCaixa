...
export function Dashboard() {
  ...
  const query = hasFilter ? `?from=${period.from}&to=${period.to}` : "";
  const report = useQuery({
    queryKey: ["report", "kpis", period.from, period.to],
