...
export class ApiExceptionFilter implements ExceptionFilter {
    ...
    const rawMessage = body.message ?? (exception instanceof Error ? exception.message : 'Erro inesperado');
    const messages = Array.isArray(rawMessage) ? rawMessage : [String(rawMessage)];
